...
const HeroSection = () => {
  ...
  return (
    <section className="relative pt-28 pb-20 overflow-hidden" id="home">
      ...
      <div className="container mx-auto px-4 relative z-10">
        <div className="flex flex-col items-center text-center mb-12 animate-fade-in">
          <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold mb-6 font-['Orbitron'] text-glow text-white">
            PRITAM X <span className="text-neon-blue">999</span>
          </h1>
          <p className="text-xl md:text-2xl font-medium text-gray-300 mb-8 text-glow-purple animate-slide-in">
          ...
          <div className="flex flex-col sm:flex-row gap-4">
            <Button 
              className="bg-neon-blue hover:bg-neon-blue/80 text-white px-8 py-6 text-lg animate-pulse-glow water-ripple"
            ...
            <Button 
              variant="outline" 
              className="border-neon-purple text-neon-purple hover:bg-neon-purple/10 px-8 py-6 text-lg"
