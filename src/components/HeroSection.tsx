...
const HeroSection = () => {
  return (
    <section className="relative pt-28 pb-20 overflow-hidden">
      ...
      <div className="absolute top-20 right-10 w-64 h-64 bg-neon-blue/10 rounded-full filter blur-3xl"></div>
      <div className="absolute bottom-10 left-10 w-72 h-72 bg-neon-purple/10 rounded-full filter blur-3xl"></div>
      ...
      <div className="container mx-auto px-4">
        <div className="flex flex-col items-center text-center mb-12">
          ...
          <p className="text-xl md:text-2xl font-medium text-gray-300 mb-8 text-glow-purple">
